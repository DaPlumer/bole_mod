...
public class GemClusterBlock extends GemBlock implements Waterloggable {
    public static final MapCodec<GemClusterBlock> CODEC = RecordCodecBuilder.mapCodec(
            instance -> instance.group(
                    ...
                    .apply(instance, GemClusterBlock::new)
    );
    ...
    @Override
    public MapCodec<GemClusterBlock> getCodec() {
        return CODEC;
    }

    public GemClusterBlock(float height, float width, AbstractBlock.Settings settings, GemType type) {
        super(settings, type);
