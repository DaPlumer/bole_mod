...
public class ModEntityTypeRegisterer extends ModDataRegisterer<EntityType<?>, EntityType.Builder<?>, EntityType<?>> {
    ...
    @Override
    public <U extends EntityType<?>> U register(@NotNull String name, @Nullable EntityType.Builder<?> instanceSettings, @Nullable Function1<? super EntityType.Builder<?>,? extends U> instanceFactory) {
