...
public final class ModArmorMaterialRegisterer extends ModDataRegisterer<ArmorMaterial, ArmorMaterialSettings,EquipmentAsset>{
    ...
    @Override
    public <U extends ArmorMaterial> U register(@NotNull String name, @Nullable ArmorMaterialSettings instanceSettings, @Nullable Function1<? super ArmorMaterialSettings,? extends U> instanceFactory) {
        ...
        @SuppressWarnings("unchecked") U instance = (U) factory.invoke(settings);
