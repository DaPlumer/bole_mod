...
public final class LogGroup {
    ...
    public void registerItemTags(FabricTagProvider.ItemTagProvider tagProvider){
        ...
        add(accessor.builder(tag), logItem, strippedLogItem, woodItem, strippedWoodItem);
        ((FabricTagProviderAccessor) tagProvider).builder(ItemTags.LOGS).addTag(tag);
        if(!log.getDefaultState().isBurnable()) add(accessor.builder(ItemTags.NON_FLAMMABLE_WOOD), logItem, strippedLogItem, woodItem, strippedWoodItem);
    ...
    public void registerBlockTags(FabricTagProvider.BlockTagProvider tagProvider){
        ...
        final FabricTagProviderAccessor accessor = ((FabricTagProviderAccessor) tagProvider);
        add(accessor.builder(tag), log, strippedLog, wood, strippedWood);
