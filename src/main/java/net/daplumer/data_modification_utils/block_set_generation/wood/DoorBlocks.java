...
public class DoorBlocks {
    ...
    public void registerItemTags(FabricTagProvider.ItemTagProvider tagProvider){
        ((FabricTagProviderAccessor) tagProvider).builder(ItemTags.WOODEN_DOORS).add(RegistryKey.of(RegistryKeys.ITEM, Registries.ITEM.getId( doorItem)));
        ((FabricTagProviderAccessor) tagProvider).builder(ItemTags.WOODEN_TRAPDOORS).add(RegistryKey.of(RegistryKeys.ITEM, Registries.ITEM.getId( trapdoorItem)));
    }
    public void registerBlockTags(FabricTagProvider.BlockTagProvider tagProvider){
        ((FabricTagProviderAccessor) tagProvider).builder(BlockTags.WOODEN_DOORS).add(RegistryKey.of(RegistryKeys.BLOCK, Registries.BLOCK.getId( door)));
        ((FabricTagProviderAccessor) tagProvider).builder(BlockTags.WOODEN_TRAPDOORS).add(RegistryKey.of(RegistryKeys.BLOCK, Registries.BLOCK.getId( trapdoor)));
    }
